"""ILI9341 TFT-LCD Driver Module -- by rdagger https://github.com/rdagger/micropython-ili9341"""
...
class LCD9341(object):
    ...
    def __init__(self, spi, cs, dc, rst,
        ...
        self.ba_SET_COLUMN = bytearray([SET_COLUMN])  # Column address set
        self.ba_SET_PAGE = bytearray([SET_PAGE])  # Page address set
        self.ba_WRITE_RAM = bytearray([WRITE_RAM])  # Memory write
        self.cas = bytearray(4) # column address set
        self.pas = bytearray(4) # page address set
    ...
    def block(self, x0, y0, x1, y1, data):
        """Write a block of data to display: faster version.
        ...
        self.dc(0) # command
        self.cs(0)
        self.spi.write(self.ba_SET_COLUMN)
        self.cs(1)
        self.dc(1) # data
        self.cs(0)
        self.spi.write(self.cas)

        # SET PAGE...
        self.cs(1)
        self.dc(0) # command
        self.cs(0)
        self.spi.write(self.ba_SET_PAGE)
        self.cs(1)
        self.dc(1) # data
        self.cs(0)
        self.spi.write(self.pas)

        # WRITE RAM...
        self.cs(1)
        self.dc(0) # command
        self.cs(0)
        self.spi.write(self.ba_WRITE_RAM)
    ...
    def clear(self, color=0, hlines=4):
        ...
        Args:
            ...
            hlines (Optional int): # of horizontal lines per chunk (Default: 2)
        Note:
